        ...
        return (
            ...
            <div className="signupc">
                <div className='signcc'>
                    ...
                    <label>First Name: </label><input id='editProfilePlaceholder' placeholder={first_name} value={firstName} onChange={e=>this.handleChange('firstName',e.target.value)} type="text" minLength='3' required/>
                    <label>Last Name: </label><input id='editProfilePlaceholder' placeholder={last_name} value={lastName} onChange={e=>this.handleChange('lastName',e.target.value)} type="text" minLength='3' required/>
                    <label>Email: </label><input id='editProfilePlaceholder' placeholder={this.props.email} value={email} onChange={e=>this.handleChange('email', e.target.value)} type="email" minLength='5' required/>
                    <br/>
                </div>
                <div className='signcc'>
                    <label>Profile Picture: </label><input id='editProfilePlaceholder' placeholder={this.props.profilePic} value={profilePic} onChange={e=>this.handleChange('profilePic',e.target.value)} type="url" minLength='5'/>             
                    <label>Bio: </label><textarea id='editProfilePlaceholder' placeholder={this.props.bio} value={bio} onChange={e=>this.handleChange('bio',e.target.value)} cols="50" rows="2" />
